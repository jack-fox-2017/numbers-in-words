function numberToWords(number) {
  ...
  if (forIndex.length == 10) {
    ...
    var toInt = parseInt(depan);
    if (toInt === 1) {
      return 'semiliar ' + numberToWords(number - (toInt * 1000000000))
    }
    return numberToWords(toInt) + ' miliar ' + numberToWords(number - (toInt * 1000000000))
  }
  ...
  if (forIndex.length == 7) {
    ...
    var toInt = parseInt(depan);
    if (toInt === 1) {
      return 'sejuta ' + numberToWords(number - (toInt * 1000000))
    }
    return numberToWords(toInt) + ' juta ' + numberToWords(number - (toInt * 1000000))
  }
...
console.log('130567040 ' + numberToWords(130567040));
...
console.log('897661330200 ' + numberToWords(897661330200));
console.log('130567551040 ' + numberToWords(130567551040));
